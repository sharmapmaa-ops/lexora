...
// of requiring manual file inspection.
...
assert(!!setMatch, 'translation-offline.js sets window.__ocrEngineBuildTag');
...
if (setMatch && compareMatch) {
  assert(setMatch[1] === compareMatch[1], 'The version string set in translation-offline.js EXACTLY matches the one app.js compares against (' + setMatch[1] + ')');
}
