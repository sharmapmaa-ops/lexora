...
assert(block.includes('window.__translationEngine.buildPdfjsTranslatedDocxBlob(pdfFileForPipeline'), 'The pdf.js text-layer pipeline is called directly in-browser with the (possibly converted) PDF');
