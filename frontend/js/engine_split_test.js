...
const requiredKeys = ['buildHybridDocxBlob', 'buildOfflineDocxBlob', 'buildBoxBasedTranslatedDocxBlob', 'buildPdfjsTranslatedDocxBlob', 'setVisionAuthToken', 'setVisionStopCheck', 'setPipelineEventHandler', 'lexoraProxyJson', 'lexoraPdfToImages', 'resetPipelineApiCounters', 'abortVision'];
