...
DOCUMENT_RESOURCES = (
    ...
    # by the browser-side translation pipeline (translation-offline.js)
    ...
    # hardcoded domain-expert personas in translation-offline.js
    ...
    # translation-offline.js) flags a SEPARATE category here whenever it
...
VIRTUAL_TABLES = {
    ...
    "doc_translation_domains": {
        ...
        # TRANSLATION_DOMAIN_EXPERTS (translation-offline.js), just
