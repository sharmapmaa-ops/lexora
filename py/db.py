...
VIRTUAL_TABLES = {
    "cfg_company": {
        ...
        "fields": [
            ...
            "shareEnabled", "currency", "twoFactorAvailable", "homeImage", "copyright",
        ...
        "field_defaults": {"twoFactorAvailable": "Yes", "imageCleaningModel": "google/gemini-3.1-flash-image", "textExtractionModel": "google/gemini-2.5-flash"},
        "readonly_fields": set(),
    },
    "doc_plans": {
        "kind": "document",
